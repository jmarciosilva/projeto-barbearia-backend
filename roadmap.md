...
- [x] `GET /dashboard/team-performance`: atendimentos concluidos, split avulso/plano, receita gerada e comissao por profissional ativo no mes corrente, ordenado por receita (mesma agregacao do extrato individual do profissional, para todos de uma vez)
...
- [x] `GET /dashboard/team-performance` exclui profissional inativo e soma corretamente atendimentos/receita/comissao so do mes corrente
